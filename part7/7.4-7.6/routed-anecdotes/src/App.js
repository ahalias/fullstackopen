...
const Anecdote = ({anecdote}) => {
  ...
  return (
    <div>
    <h1 key={anecdote.id} >{anecdote.content} by {anecdote.author}</h1>
...
const border = {
  ...
  return (
    <div>
      {notification !== null && 
      <div style={border}>{notification}</div>}
...
const CreateNew = (props) => {
  ...
  const handleReset = () => {
    content.onChange(null, true)
    author.onChange(null, true)
    info.onChange(null, true)
  }
